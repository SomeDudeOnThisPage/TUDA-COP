...
public final class ClassFunctionAccessExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97a51900650f4519L, 0xa79289e9b2b161cbL, 0x79adcda68aa7076bL, "ExerciseLanguage.structure.ClassFunctionAccessExpression");
  ...
  /*package*/ static SEnumerationLiteral getEvaluatedType_id1nPabnO2END(@NotNull SNode __thisNode__) {
    return IEvaluatable__BehaviorDescriptor.getEvaluatedType_id1nPabnO2END.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.functionExpression$k890));
  }

  /*package*/ ClassFunctionAccessExpression__BehaviorDescriptor() {
  }
