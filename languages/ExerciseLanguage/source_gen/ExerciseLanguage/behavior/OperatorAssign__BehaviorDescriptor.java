...
public final class OperatorAssign__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97a51900650f4519L, 0xa79289e9b2b161cbL, 0x5261d8e675c62f7eL, "ExerciseLanguage.structure.OperatorAssign");
  ...
  /*package*/ static SEnumerationLiteral getExpectedType_id5fpBcul7cQ7(@NotNull SNode __thisNode__) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), CONCEPTS.BinaryExpression$lR)) {
      return IEvaluatable__BehaviorDescriptor.getEvaluatedType_id1nPabnO2END.invoke(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), CONCEPTS.BinaryExpression$lR), LINKS.left$sOE2));
    }
  ...
  /*package*/ OperatorAssign__BehaviorDescriptor() {
  }
