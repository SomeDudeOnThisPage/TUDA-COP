...
public class Return_Constraints extends BaseConstraintsDescriptor {
  public Return_Constraints() {
    super(CONCEPTS.Return$70);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(parentNode), CONCEPTS.ClassConcept$S3));
  }
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:cdccb337-955c-47f5-9e0b-861587339752(ExerciseLanguage.constraints)", "1582215606041300766");
