...
/*package*/ class VariableReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.reference$vRxJ;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.reference$vRxJ);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.reference$vRxJ);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ge17fi_c0");
